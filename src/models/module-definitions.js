export const MODULE_DEFINITIONS = [
  ...
  },
  {
    ...
    label: "Indikationen",
    model: "indication",
    description: "Terminologie-Indikationen fuer Untersuchungen, Follow-up und klinische Kontexte.",
    dependsOn: ["lx_classifications", "lx_interventions"],
    fields: [
  ...
  },
  {
    ...
    fields: [
      { key: "name", label: "Name", type: "text", placeholder: "colon_lesion_paris", required: true },
      {
        ...
        type: "text",
        placeholder: "Formklassifikation Kolonlaesion",
      },
      {
        key: "name_en",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "text_max_length", label: "Textlaenge Maximum", type: "number", placeholder: "255" },
      ...
      { key: "default_value_bool", label: "Standardwert Boolean", type: "boolean" },
